...
Otra forma de clasificar las pruebas.
- __Caja negra:__
Se estudia el sistema desde fuera. Son pruebas funcionales.Ejecutamos el codigo y vemos el resultado, comprobamos la funcionalidad no sabemos lo que hace internamente, vemos la entrada y salida.

- __Caja blanca o Transparente:__
Se examina el código fuente y su ejecución. Son pruebas estructurales.Vemos como se va ejecutando el codigo, y vemos si está funcionando correctamente.
...
- Se trabaja sobre la interfaz. No tiene que ser interface de usuario, puede ser de red o de programación(API).
- No se tienen en cuenta los detalles internos de funcionamiento.
- Se proporcionan entradas y se estudian las salidas.
- Principales técnicas:
  - Particiones de equivalencia dividimos los distintos tipos de pruebas en partes.
  - Valores límite
...
- Principales técnicas:
  - Cobertura lógica o del código.Todos los caminos del código se ejecutan.
  - Prueba de bucles
...
- __No funcionales:__
Evaluan aspectos adicionales como rendimiento, seguridad, ...  aunque funcionen correctamente.


### Pruebas funcionales

- Pruebas unitarias (o de unidad) se hacen pruebas de cada clases y metodos de cada una.
- Pruebas de regresión cuando vamos escribiendo codigo nuevo, podemos introducir errores, estas pruebas comprueban que no volvemos atras es decir que las pruebs que antes se pasaban ahora se pasan tambien.
- Pruebas de integración juntarlo todos y que funcionen correctamente en conjunto. Son menos automatizables 
- Pruebas del sistema suelen ser la no funcionales, rendimiento, seguridad.
- Pruebas de humo (smoke test) Comprueba los componente o funcionalidades básica de la aplicación. Login, conexión BBDD.
- Pruebas alfa y beta. BETA lo prueban en entorno no controlado fuera de la empresa , la alpha dentro de la empresa en un entorno controlado.
