...
- Mediante analizadores estáticos (__linters__) son programas.
...
- Moderno 
- Distribuido no tenemos por que tenerlo solo en red , en local tambien y en varios equipos.
- Eficiente 


### Git (Conceptos)

- Repository (local & remote) sinónimo de proyecto.
- Commit Guardar
- Branch  Rama.
  - Checkout
